...
import { Card, Button, StatusBadge, Badge, Select } from '../../../components/UI';
...
export default function CaseDetailPage() {
  ...
  useEffect(() => {
    if (params.id) {
      setCaseData(db.getCaseById(params.id as string));
    }
  }, [params.id]);

  if (!caseData) return <MainLayout><div className="p-8 text-center">案件が見つかりません</div></MainLayout>;
