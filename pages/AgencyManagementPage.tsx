...
// Fix: Changed props to any and added optional key to satisfy strict TS checking of custom components in JSX
const TreeItem = ({ agency, allAgencies, allReferrals }: { agency: any, allAgencies: any[], allReferrals: any[], key?: any }) => {
