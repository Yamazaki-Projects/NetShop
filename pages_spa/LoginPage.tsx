    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--bg-main)' }}>
      <div style={{ width: '100%', maxWidth: '420px', padding: '24px' }} className="animate-fade-in">
        <div style={{ textAlign: 'center', marginBottom: '40px' }}>
          ...
          <p style={{ color: 'var(--text-sub)', fontWeight: 600 }}>Supabase 連携済みシステム</p>
        </div>
        <Card style={{ padding: '40px' }}>
          <form onSubmit={handleSubmit}>
            <Input label="メールアドレス" type="email" value={email} onChange={(e) => setEmail(e.target.value)} required placeholder="yamada@example.com" />
